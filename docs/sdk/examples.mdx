...
class ReceiptProcessor(Agent):
    ...
    def _register_tools(self):
        ...
        def process_receipt(image_path: str) -> dict:
            ...
            extracted = self.vlm.extract_from_image(image_bytes, prompt=prompt)
...
- [Core Agent System](/sdk/core/agent-system) - Agent architecture
- [Tool Mixins](/sdk/mixins/tool-mixins) - Reusable tool collections
- [RAG SDK](/sdk/sdks/rag) - Document search
- [Vision-Language Models](/sdk/sdks/vlm) - Image processing
