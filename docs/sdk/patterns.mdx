...
- [Registry source](https://github.com/amd/gaia/blob/main/src/gaia/agents/registry.py) — `KNOWN_TOOLS` map, `AgentManifest` model
- [Manifest JSON Schema](https://github.com/amd/gaia/blob/main/schemas/agent-manifest.schema.json) — editor autocomplete for `agent.yaml`
