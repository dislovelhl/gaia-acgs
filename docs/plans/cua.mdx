...
This agent is a **specific implementation** of the [MCP Client Mixin](/sdk/infrastructure/mcp) pattern (the base mixin shipped in v0.15.4):
...
- [MCP Client](/sdk/sdks/mcp) - MCP protocol documentation and the shipped client SDK
