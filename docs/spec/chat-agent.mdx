...
class ChatAgentConfig:
    ...
    # Debug/output
    debug: bool = False
    debug_prompts: bool = False     # Backward-compatible alias for show_prompts
    ...
    library_documents: List[str] = field(default_factory=list)  # UI-attached docs
    ...
    ui_session_id: Optional[str] = None      # resume an Agent-UI session
