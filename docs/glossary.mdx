...
### LEMONADE_BASE_URL
Environment variable specifying the address of the Lemonade Server (default `http://localhost:8000/api/v1`). The GAIA OpenAI-compatible API server runs on port 8080 — don't confuse the two.
