...
After installing the desktop app, skip ahead to [Build Your First Agent](#build-your-first-agent) below if you want to dive straight into coding — the app takes care of the rest.
...
To install a specific version (current release is **v0.17.2**):

```bash
npm install -g @amd-gaia/agent-ui@0.17.2
```
