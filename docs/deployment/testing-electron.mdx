...
All Electron-related tests live under `tests/electron/`. Unit tests for framework
services sit alongside integration tests for individual apps:
...
Shared setup lives in `tests/electron/setup.js`; mocks live under
`tests/electron/mocks/`.
