...
- **Vision-language model (VLM) support** — `gaia::Image` + `processQuery(..., images)` overloads send images inline to OpenAI-compatible vision endpoints; see [API Reference](/cpp/api-reference#vision-language-models-vlm)
