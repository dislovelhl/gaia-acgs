...
<Warning>
**Roadmap page — not all commands shown are implemented.** The `gaia package
--agent ... --ui web/electron` CLI sketched below is a planned convenience
...
the [Electron Integration spec](/spec/electron-integration) for what's
currently shipping.
</Warning>

![Status](https://img.shields.io/badge/status-in_development-yellow)

**Detailed Spec:** [spec/electron-integration](/spec/electron-integration)
...
- [API Server](/reference/api) - Expose agents via API
- [Best Practices](./best-practices) - Development guidelines
- [Desktop Installer Plan](/plans/desktop-installer) - NSIS-based installer with bundled Lemonade MSI (in progress)
